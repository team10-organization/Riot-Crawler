...
public class RiotApiClient {
    ...
    public Set<LeaguePosition> requestSummonerInfo(String encryptedId) {
        return restTemplate.exchange(OpenRiotUrl_getSummonerInfo, HttpMethod.GET, null, new ParameterizedTypeReference<Set<LeaguePosition>>() {
        }, encryptedId, api_key).getBody();
    }
}
